...
public class KeycloakAdminServiceTests {
    ...
    void whenRetrieveAllPilotCodes_thenReturnListOfGroupNames() {
        ...
        when(groupsResource.groups()).thenReturn(List.of(group1, group2));
    ...
    // ==================== Retrieve Sub Group By Name and Parent Tests ====================
    ...
    void givenValidPilot_whenNotExists_thenCreatePilot() {
        ...
        PilotCreationDto dto = new PilotCreationDto(TEST_GROUP_NAME, List.of("sub1", "sub2"));

        adminService.createPilot(dto);

        // Verify add() was called once with proper GroupRepresentation
        verify(groupsResource).add(argThat(gr -> gr.getName().equals(TEST_GROUP_NAME)));
    }
    ...
    void givenPilotAlreadyExists_whenCreate_thenThrowResourceAlreadyExistsException() {
        ...
        PilotCreationDto dto = new PilotCreationDto(TEST_GROUP_NAME, List.of());
    ...
    // ==================== Assign User Role to Pilot Tests ====================
    ...
    // ==================== Retrieve All Client Role Representations for Specific Group Tests ====================
    ...
    // ==================== Retrieve All Group Representations Tests ====================
    ...
    // ==================== Retrieve Realm Representation By Name Tests ====================
    ...
    // ==================== Retrieve All Pilot Roles Tests ====================
    ...
    // ==================== Retrieve All Realm Representation Tests ====================
    ...
    // ==================== Retrieve Client Representation Tests ====================
    ...
    // ==================== Retrieve All Client Role Representation Tests ====================
    ...
    // ==================== Retrieve Client Role Representation by Name Tests ====================
