...
public class UserManagementService implements IUserManagementService {
    ...
    @Caching(evict = {
            ...
            @CacheEvict(value = "users", key = "'all-users'"),
            // Evict specific pilotCode cache
            @CacheEvict(value = "users", key = "#userData.pilotCode()", condition = "#userData.pilotCode() != null"),
            // Evict specific userRole cache
            @CacheEvict(value = "users", key = "#userData.userRole()", condition = "#userData.userRole() != null"),
            // Evict specific pilotCode::userRole combination
            @CacheEvict(value = "users", key = "#userData.pilotCode() + '::' + #userData.userRole()",
                    condition = "#userData.pilotCode() != null && #userData.userRole() != null")
    })
