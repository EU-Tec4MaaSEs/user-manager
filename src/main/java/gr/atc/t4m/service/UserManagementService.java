...
public class UserManagementService implements IUserManagementService {
    ...
    private static final long ACTIVATION_TOKEN_EXPIRY_MS = TimeUnit.HOURS.toMillis(24);
    ...
    public String createUser(UserCreationDto userData, String autogeneratedToken) {
        ...
        user.setActivationExpiry(String.valueOf(System.currentTimeMillis() + ACTIVATION_TOKEN_EXPIRY_MS)); // 24 Hours expiration time
